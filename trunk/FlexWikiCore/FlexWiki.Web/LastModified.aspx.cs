...
namespace FlexWiki.Web
{
    ...
    public class LastModified : BasePage
    {
        ...
        {
            uniqueNamespaces = new ArrayList(Federation.Namespaces);
        ...
        protected string NamespaceFilter()
        {
            ...
            foreach (string ns in uniqueNamespaces)
            {
                ...
                result += "<option " + sel + " rawValue='" + ns + "'>" + ns + "</option>";
            }
            result += "</select>";
            return result;
        }
        ...
        protected void DoSearch()
        {
            ...
            foreach (string author in uniqueAuthors)
                Response.Write("<option rawValue='" + author + "'>" + author + "</option>");
            ...
            foreach (QualifiedTopicRevision topic in topics)
            {
                ...
                Response.Write("</td>");
                Response.Write("<td>");
                Response.Write(Escape((string) (authors[topic])));
                Response.Write("</td>");
                Response.Write("</tr>");
            }
