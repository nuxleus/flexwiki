...
namespace FlexWiki
{
	...
	public class Presentations :BELObject
	{
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present an image")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present a hyperlink")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present a hidden property")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present an input property")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present a textarea")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present a checkbox")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present a radio")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present a label")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Start a form")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present a submit button")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present a reset button")]
		...
		[ExposedMethod(ExposedMethodFlags.Default, "Present an image button")]
